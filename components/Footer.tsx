  ...
  return (
    <footer className="py-24 px-6 border-t border-earth-green/5">
      ...
      <div className="max-w-7xl mx-auto pt-16 flex flex-col md:flex-row justify-between items-center text-[10px] font-bold uppercase tracking-widest text-earth-green/30">
        <p>© 2026 · made by <a href="https://x.com/mat_misztoft" target="_blank" rel="noopener noreferrer" className="text-earth-green hover:text-earth-green/60 transition-colors">@mat_misztoft</a>, for anyone tired of postage-stamp video</p>
        <a href="/faq" className="mt-4 md:mt-0 hover:text-earth-green/60 transition-colors">FAQ</a>
      </div>
    </footer>
  );
}
