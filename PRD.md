...
The repository is no longer a blank scaffold. As of version `1.0.1`, it contains a working browser extension with a real in-feed widening flow for supported X videos.
